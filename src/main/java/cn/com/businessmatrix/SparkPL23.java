        ...
        //while(true)
        {
            ...
            String sql_lookdf =
                    "(select cast(fnv_hash("
                            ...
                            " left join  " + schema + ".trd_ta_saletran t on t1.sk_invpty_of_cust = t.sk_invpty_of_cust " +
                            ...
                            //==================================================
                            " and t1.dk_system_of_sdata='" + srcsys + "' and t1.shares>0 and t2.effective_to=99991231 " +
                            //"  and t1.sk_invpty_of_cust =1352643 " +
                            " ) as tt";
			...
			*/
            ...
            String sql =
                    "(select cast(fnv_hash("
                            ...
                            " and t.dk_system_of_upd='" + srcsys + "' and m.shr_chg_dir = -1 " +
                            " and pp.dk_money_fund='N' and t.dk_saletran_status='1' " +
                            //" and t.sk_invpty_of_cust =1352643 " +
                            ") as tt";
