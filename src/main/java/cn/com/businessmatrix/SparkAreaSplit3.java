		...
		*/
        ...
        String sql_data =
                " (SELECT t.shr_chg_serialno,\n" +
                        ...
                        "   AND ('" + pi_run_type + "' = '1' OR ('" + pi_run_type + "' = '2' AND EXISTS (SELECT 1 FROM " + schema + ".org_areasplit_reload rd WHERE rd.reload_serialno = t.shr_chg_serialno AND rd.dk_reload_type='4'))) \n" +
