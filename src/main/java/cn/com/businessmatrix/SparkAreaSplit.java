		...
		*/
        ...
        String sql_schema =
                "( SELECT t.trd_st_trx_serialno,\n" +
                        ...
                        "		t.dk_cust_type,\n" +
                        "       t.area_rule_id,\n" +
                        "       t.dk_org_tree AS dk_org_tree_of_brnch,\n" +
                        "       t.sk_invpty_of_brchorg AS sk_invpty_of_brnchorg,\n" +
                        "       t.dk_org_tree_of_bl,\n" +
        ...
        String sql_data =
                "(SELECT         t.trd_st_trx_serialno,\n" +
                        ...
                        "   AND ('" + pi_run_type + "' = '1' OR ('" + pi_run_type + "' = '2' AND EXISTS (SELECT 1 FROM " + schema + ".org_areasplit_reload rd WHERE rd.reload_serialno = t.trd_st_trx_serialno AND rd.dk_reload_type='1'))) \n" +
        ...
        //hc.createDataFrame(x, st).where("area_rule_id <> 99999").show();

        //hc.sql("invalidate metadata ods.tmp_trd_ta_saletran_arsplt_spark");
