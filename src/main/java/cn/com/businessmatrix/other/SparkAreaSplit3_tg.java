...
public class SparkAreaSplit3_tg {
		...
		*/
        ...
        String sql_data =
                " (SELECT t.shr_chg_serialno,\n" +
                        ...
                        "       t.dk_system_of_sdata,\n" +
                        "       t.dk_share_type\n" +
                        "  FROM  " + schema + ".ass_ta_saletran_fundbal_chg_tg   t\n" + //ass_ta_fundbal_chg
        ...
        String sql_rule =
                "WITH a AS\n" +
                        ...
                        "   FROM " + schema + ".org_areasplit_common_tg t1\n" +
        ...
        String sql_mapp = "( WITH a AS\n" +
                ...
                "          t.dk_anal_dymic\n" +
                "   FROM " + schema + ".org_areasplit_common_tg t\n" +
