...
public class SparkAreaSplit3_007 {
		...
		*/
        ...
        String sql_rule =
                "WITH a AS\n" +
                        ...
                        "   FROM " + schema + ".org_areasplit_common_007 t1\n" +
                        ...
                        "   AND t3.dk_region_tree = '01'"
                        // 增加时间限制
                        + " WHERE t1.effective_from <= " + pi_enddate + " AND t1.effective_to >= " + pi_startdate + " )\n" +
        ...
        String sql_mapp = "( WITH a AS\n" +
                ...
                "          t.dk_anal_dymic\n" +
                "   FROM " + schema + ".org_areasplit_common_007 t\n" +
