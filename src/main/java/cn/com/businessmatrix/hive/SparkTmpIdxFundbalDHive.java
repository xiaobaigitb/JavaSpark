 ...
 *
 */
public class SparkTmpIdxFundbalDHive {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sql = " select " +
                ...
                " product_short_name, dk_sex, dk_age_range, sk_region,  dk_open_age_range, sk_agency, " +
                " agencyno, agency_branch_name,  dk_amount_range,   bus_date ";
