 ...
 *  
 */
public class SparkPLAvgHivePre {
		...
		*/
...

        {
            ...
            sql_lookdf = "   select  concat_ws(',',"
                    ...
                    " inner join   " + schema + ".tmp_ass_ta_cust_income_avgcost_twd" + postfix + " t3 on  t1.sk_account_of_fd = t3.sk_account_of_fd " +
            ...
            sql = "  select  concat_ws(',',"
                    ...
                    " inner join   " + schema + ".tmp_ass_ta_cust_income_avgcost_twd t1 " +
                    "            on t1.sk_account_of_fd = t.sk_account_of_fd " +
