...
public class SparkPLAvgHiveYH {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String transferInTypes = "(127)";
        //String transferOutTypes="(128,135)";//args[8];//转托管出，非交易过户出
        String transferOutTypes = "(128)";
...

        {
            ...
            if ("1".equals(step)) {
                ...
                sql_lookdf = "  select  concat_ws(',',"
                        ...
                        + "cast(t1.sk_product       as string), t1.dk_share_type)  as hashcode, " + //0 份额类型在博时没有意义
                        ...
                        " inner join  " + schema + "." + notinTable + "  t  on t1.sk_account_of_fd = t.sk_account_of_fd " +
                        " and t1.sk_tradeacco_reg = t.sk_tradeacco_reg " +
                        " and t1.sk_product       = t.sk_product " +
                        " and t1.dk_share_type    = t.dk_share_type " +
                        " left join   " + schema + "." + inTable + "  t3 on  t1.sk_account_of_fd = t3.sk_account_of_fd " +
                ...
                sql_lookdf = "   select  concat_ws(',',"
                        ...
                        "  from " + schema + "." + avgcostTable + "  t1 inner join " +
                        schema + "." + etTable + "  t2 on t1.trd_it_trx_serialno=t2.trd_it_trx_serialno " +
                        " inner join   " + schema + "." + inTable + "  t3 on  t1.sk_account_of_fd = t3.sk_account_of_fd " +
                        " and t1.sk_tradeacco_reg = t3.sk_tradeacco_reg " +
                        " and t1.sk_product 	  = t3.sk_product " +
                        " and t1.dk_share_type    = t3.dk_share_type " +
                        " where t1.dk_system_of_sdata='" + srcsys + "'  and t2.effective_to=99991231 " +
