...
public class SparkAgencySplitTest {
    ...
    static void initRules(Row[] r) {
        String sql_rule = "select t1.ag_split_ruleno " +
                ...
                "              ,t1.effective_from " +
                "              ,t1.effective_to " +
                "          from ods.ip_agency_split_param t1 " +
                "         where t1.dk_enabled_flag = 'Y' order by t1.priority";
        StructField[] sfs = new StructField[11];
        sfs[0] = new StructField("ag_split_ruleno", new DecimalType(12, 0), true, null);
        sfs[1] = new StructField("agencyno", DataTypes.StringType, true, null);
        sfs[2] = new StructField("rule_name", DataTypes.StringType, true, null);
        sfs[3] = new StructField("rule_exp1", DataTypes.StringType, true, null);
        sfs[4] = new StructField("rule_exp2", DataTypes.StringType, true, null);
        sfs[5] = new StructField("rule_exp3", DataTypes.StringType, true, null);
        sfs[6] = new StructField("rule_exp4", DataTypes.StringType, true, null);
        sfs[7] = new StructField("rule_exp5", DataTypes.StringType, true, null);
        sfs[8] = new StructField("priority", new DecimalType(4, 0), true, null);
        sfs[9] = new StructField("effective_from", new DecimalType(8, 0), true, null);
        sfs[10] = new StructField("effective_to", new DecimalType(8, 0), true, null);
    ...
    static Row[] initData() {
        ...
        sfs[14] = new StructField("ds_agencyno", DataTypes.StringType, true, null);
        ...
        r[0] = SparkSplitUtils.gr(RowFactory.create(
                new BigDecimal(654321L),  //0
                "TA", //1 sk_invpty_type
                null,//2 sk_invpty
                null,//3 sk_invpty
                "6666",//4
                "9",//5
                "33234234234234234234",//6
                null,//7
                null,//8
                null,//9
                "M",               //10 dk_tano
